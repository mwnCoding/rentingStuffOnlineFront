...
function SignupPage() {
  ...
  const handleSubmit = (e) => {
    ...
    if (newForm.isValid() && !imageLoading) {
      const formData = {
  ...
  return (
    <Flex direction="column" justify="center">
      ...
      <Flex wrap="wrap" direction="column" gap="xs" w="100%" justify="center">
        <ProfilePictureInput
          value={newForm.getInputProps("imgUrl").value}
